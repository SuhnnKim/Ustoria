...
<div id="left_sidebar" ng-controller="LeftSidebarController">
    ...
    <div id="sidebar" ng-hide="sidebar.hidden">
        ...
        <div class="inner">
                        ...
                        <ul id="character-list">
                            <c:if test="${not empty characterList}">
                                ...
                                <c:forEach var="character" items="${characterList}">
                                    <li class="draggable menu_item" id=
                                        <c:out value="${character.getName()}"/>>
                                        <a href="<c:out value="loadCharacter?id=${character.getId()}"/>"><c:out
                                                value="${character.getName()}"/></a>
                                    </li>
                                </c:forEach>
            ...
            <div class="link-playground-wrapper"><a id="link-playground" href="#">Save Story</a></div>
